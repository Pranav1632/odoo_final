...
export function PayrunDetail() {
  ...
  const attachNotice = location.state?.attachNotice;
      ...
      {attachNotice && (
        <div className="p-4 bg-amber-50 border border-amber-200 rounded-2xl flex items-start gap-3 text-amber-800 text-sm">
          <svg className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l6.516 11.59c.75 1.334-.213 2.987-1.743 2.987H3.483c-1.53 0-2.493-1.653-1.744-2.987l6.516-11.59zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd"/>
          </svg>
          <div>
            <p className="font-semibold">Employee Selection Notice</p>
            <p className="text-xs text-amber-700 mt-0.5">{attachNotice}</p>
          </div>
        </div>
      )}
